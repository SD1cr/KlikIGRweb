...
class TransactionDetail extends Model
{
    ...
    public static function insertDetail($kdTran, $plu, $qty, $harga, $disc, $subtotal, $picprod){
        $date = new \DateTime;
...
//            ->Where('pic_kodeigr', $kodecabang);
        ...
        $trans = $trans->Where('transaction_headers.kode_transaksi', $invoiceID)
            ->Get();
        return $trans;
    }
...
//            })
//            ->Join('invoice', 'invoice.id', '=', 'transaction_headers.invoice_id')
            ->Where('transaction_headers.kode_transaksi', $invoiceID);

...
//            ->Where('userid','ADM')
    ...
    public static function countStockReserve($PLU, $ADDR = NULL){
        if($ADDR == NULL){
            $ADDR = Address::getDefaultAddress();
        }
...
//                ->Where('address_id', $ADDR)
    ...
    public static function getcountcartall(){
        try{
            $cartQty = Cart::Where('userid', \Auth::User()->id)
                ->get();
            return $cartQty;
    ...
    public static function addCartItem($PLU, $QTY, $UNIT = null, $po_no = null){
        ...
        try{
            ...
            $StockResQty = Cart::countStockReserve($PLUs, Address::getDefaultAddressId());
...
//                    ->Where('userid','ADM')
               ...
               if($StockResQty > 0){
                   ...
                   StockReserve::Where('PLU', $PLUs)
                       ->Where('kode_igr', $kodecabang)
                       ->Update($array);
               }else{
                   \DB::table('stock_reserves')->insert(

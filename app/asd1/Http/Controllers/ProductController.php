...
//        $newkatAssoc = NewCategory::getNewKatAll();
        $htmlFormat .= "<div id=\"index2_banner\" class=\"row\" style=\"margin-bottom:10px;\">";
        $htmlFormat .= "<div class=\"hidden-xs col-md-3\" style='width: 20%; padding-left: 0px;z-index: 1000;'>
                        <div class='profile-sidebar' style='box-shadow : 0 1px 4px 0 rgba(0, 0, 0, 0.14);padding-top: 0px; padding-bottom: 10px;'>";
//        foreach ($newkatAssoc as $index => $katRow) {
        $htmlFormat .= "<a id='dLabel' role='button' data-toggle='dropdown' class='btn btn-danger flat' style='font-weight: bold ;font-size: small; color: white;text-align:left; padding-left:6px; width: 100%' data-target='#' href='/page.html'>
            KATEGORI BELANJA  &nbsp;
            </a>";
        $divisiAssoc = Div::getAllDivisi();
        ...
        $htmlFormat .= "</div></div>";
        $htmlFormat .= "<div class=\"hidden-xs col-md-9 owl-carousel2\" style='width: 80%;padding-left: 0px; padding-right: 0px;'>";
//        $htmlFormat .= "
//        <div class='row'>
//            <div class='col-sm-6'>
//              <img style='margin-bottom: 10px; width:425px;height: 185px;' src='http://placehold.it/380x165'  alt='' class='img-responsive center-block col-sm-12'>
//             <div class='row col-sm-12'>
//                <div class='col-xs-6'>
//                 <img style='margin-bottom: 10px;width:181px;height: 185px;' src='http://placehold.it/210x215' alt='' class='img-responsive'>
//                </div>
//                 <div class='col-xs-6'>
//                 <img style='margin-bottom: 10px;width:181px;height: 185px;' src='http://placehold.it/210x215' alt='' class='img-responsive'>
//                </div>
...
//        </div>";
        foreach ($banner as $index => $BanRow) {
            $htmlFormat .= "<div>
                            <a href=" . $BanRow->url . "><img width=\"100%\" height='333px' src='https://www.klikindogrosir.com/public/image/" . $BanRow->images . "' alt=" . $BanRow->altname . "></a>
                            </div>";
        }
        $htmlFormat .= "</div>";
        ...
        <div class=\"hidden-xs col-sm-12\" style=\"min-height: 0px;box-shadow : 0 1px 4px 0 rgba(0, 0, 0, 0.14); margin-bottom: 20px;padding-left: 0px;padding-right: 0px;margin-top: 20px;\">
            ...
            <div class=\"col-sm-12 owl-carousel1\" style='width: 100%;padding-left: 0px; padding-right: 0px; max-height: 100%;'>";
...
//    {
//        $htmlFormat = "";
//        $banner = \DB::table('banners')->distinct()->where('start_date', '<=', Carbon::today())
//            ->where('end_date', '>=', Carbon::today())
//            ->WhereNull('deleted_at')
//            ->OrderBy('priority')->get();
////        $newkatAssoc = NewCategory::getNewKatAll();
//        $htmlFormat .= "<div id=\"index2_banner\" class=\"row\" style=\"margin-bottom:10px;\">";
//        $htmlFormat .= "<div class=\"col-md-3\" style='width: 20%; padding-left: 0px;z-index: 1000;'>
//                        <div class='profile-sidebar' style='box-shadow : 0 1px 4px 0 rgba(0, 0, 0, 0.14);padding-top: 0px; padding-bottom: 10px;'>";
////        foreach ($newkatAssoc as $index => $katRow) {
//        $htmlFormat .= "<a id='dLabel' role='button' data-toggle='dropdown' class='btn btn-danger flat' style='font-weight: bold ;font-size: small; color: white;text-align:left; padding-left:6px; width: 100%' data-target='#' href='/page.html'>
//            KATEGORI BELANJA  &nbsp;
...
//        foreach ($divisiAssoc as $index => $row) {
//            $htmlFormat .= "<li class=\"dropdown-submenu\" style=\"list-style-type:none; padding-top: 10px;padding-bottom: 10px;padding-left: 10px;padding-right: 10px;margin-right: 10px;white-space: nowrap;\">
//                        <a class='kigr-hover' tabindex=\"-1\" href=" . url("list/" . $row->DIV_KODEDIVISI) . " style=\"font-size: small; color: black;\" >$row->DIV_NAMADIVISI</a>";
//            $htmlFormat .= "<ul class=\"dropdown-menu\" style='overflow:auto;max-height:500px; min-height: 350px;  margin-top: 0px;position: absolute !important;top:-". ((40*$index)+35) ."px !important; left:100% !important;'>";
//            $depAssoc = Dep::getDepByDivisi($row['DIV_KODEDIVISI']);
//            foreach ($depAssoc as $index => $row) {
//                $htmlFormat .= "<li style='width: 960px; padding-bottom: 20px '><a class='kigr-hover' href=" . url("list/" . $row->DEP_KODEDIVISI . "/" . $row->DEP_KODEDEPARTEMENT) . " style=\"font-size: small;color: #3498db;\">$row->DEP_NAMADEPARTEMENT</a>";
//                $htmlFormat .= "<dt class=\"dropdown-menu\">";
//                $kategoriAssoc = Category::getKatByDep($row['DEP_KODEDEPARTEMENT']);
//                foreach ($kategoriAssoc as $index => $row) {
//                    $htmlFormat .= "<dd class='col-md-2' style='white-space: nowrap;font-size: x-small !important;'><a class='kigr-hover' href=" . url("list/" . $row->DEP_KODEDIVISI . "/" . $row->KAT_KODEDEPARTEMENT . "/" . $row->KAT_KODEKATEGORI) . " style=\"font-size: small !important; color: black;\">" . ucwords(strtolower($row->nama)) . "</a></dd>";
//                }
//                $htmlFormat .= "</dt>";
//                $htmlFormat .= "</li>";
//            }
...
//        }
//        $htmlFormat .= "</div></div>";
//        $htmlFormat .= "<div class=\"col-md-9 owl-carousel\" style='width: 80%;padding-left: 0px; padding-right: 0px;'>";
//        foreach ($banner as $index => $BanRow) {
//            $htmlFormat .= "<div>
//                            <a href=" . $BanRow->url . "><img width=\"100%\" height='283px' src='http://192.168.10.202/cms/public/" . $BanRow->images . "' alt=" . $BanRow->altname . "></a>
//                            </div>";
//        }
//        $htmlFormat .= "</div>";
//        $htmlFormat .= "</div>";
...
//            $contentFormat .= "<div class=\"col-xs-12\" style='padding-right: 0px !important;'>";
            $contentFormat .= "<div class=\"col-xs-12 owl-carousel\">
...
//            $contentFormat .= "</div>";
            ...
            foreach ($prodTenant as $index => $Prodrow) {
                ...
                if ($Prodrow->url_pic_prod != null) {
                    ...
                    $contentFormat .= "<img src=\"" . url('../resources/assets/img/noimage.png') . "\" class=\"img-responsive imgbox\" height=\"80%\" width=\"80%\">";
                }
                $contentFormat .= "
        ...
        foreach ($SectioHeaderAssoc as $index => $HdrRow) {
            ...
            $contentFormat .= "<div class=\"col-xs-12\" style='max-width: ; box-shadow : 0 1px 4px 0 rgba(0, 0, 0, 0.14);'>
                                  <div class=\"col-md-3 col-sm-6\" style='padding-top: 8px !important;height:100%;'>
                                      ...
                                      <img height=\"25\" width=\"25\" src='https://www.klikindogrosir.com/public/image/" . $HdrRow->icon . "'>&nbsp;". $HdrRow->name."</a>
...
//            $depAssoc = Dep::getDepByDivisi($Divrow['DIV_KODEDIVISI']);
            ...
            $contentFormat .= "<div class=\"col-xs-12 owl-carousel2\" style='height:440px;padding-right: 0px;padding-left: 0px;'>";
            foreach ($SectionBannerAssoc as $index => $BanRow) {
                $contentFormat .= "<div><a href=" . $BanRow->url . "><img height='400px' width=\"100%\" src='https://www.klikindogrosir.com/public/image/" . $BanRow->image . "' alt=" . $BanRow->alt_name . "></a></div>";
            }
            $contentFormat .= "</div>";
...
//                    var_dump(env('URLPRODUCT'));
                    foreach ($SectionItemAssoc as $index => $Prodrow) {
                        if ($Prodrow->priority !== 7) {
                            ...
                            $contentFormat .= "";
                            $contentFormat .= "<a href=" . $Prodrow->url . "><img style=\"padding:10%;\" src='https://www.klikindogrosir.com/public/image/" . $Prodrow->image . "' class=\"img - responsive imgbox\" height=\"219px\" width=\"100%\"></a>";
                            $contentFormat .= "</div>";
                        } else {
                            $highlight = "<a href=" . $Prodrow->url . "><img class='col-xs-12' src='https://www.klikindogrosir.com/public/image/" . $Prodrow->image . "' class=\"img_banner_kanan - responsive imgbox\"  style='padding-left:0; padding-right:0px;' ></a>";
                        }
                    ...
                    foreach ($SectionItemAssoc as $index => $Prodrow) {
                        ...
                        $contentFormat .= "<a href=" . $Prodrow->url . "><img src='https://www.klikindogrosir.com/public/image/" . $Prodrow->image . "' class=\"img - responsive imgbox\" style='padding:10%;' height=\"219px\" width=\"100%\"></a>";
                        $contentFormat .= "</div>";
                    }
                    $contentFormat .= "</div>";
                    $contentFormat .= "</div>";
            ...
            foreach ($SectionBrandAssoc as $index => $BrandRow) {
                ...
                $contentFormat .= "<div><a href=" . $BrandRow->url . "><img width='100%' src='https://www.klikindogrosir.com/public/image/" . $BrandRow->image . "'></a></div>";
                $contentFormat .= "</div>";
            }
            $contentFormat .= " </div>";
            $contentFormat .= " </div>";
...
//            $contentFormat .= "</div>";
        ...
        foreach ($SectioHeaderAssoc as $index => $HdrRow) {
            ...
            foreach ($SectionBannerAssoc as $index => $BanRow) {
                ...
                $contentFormat .= "<div class='item $tes'><a href=" . $BanRow->url . "><img class='thumbnail' src='https://www.klikindogrosir.com/public/image/" . $BanRow->image . "' alt=" . $BanRow->alt_name . "></a></div>";
            }
            $contentFormat .="</div>
...
//
//            $contentFormat .= "<div class='col-xs-12 owl-carousel2' style=';padding-right: 0px;padding-left: 0px;'>";
//            foreach ($SectionBannerAssoc as $index => $BanRow) {
//                $contentFormat .= "<div><a href=" . $BanRow->url . "><img class='img-responsive' src='https://www.klikindogrosir.com/public/image/" . $BanRow->image . "' alt=" . $BanRow->alt_name . "></a></div>";
//            }
//
//            $contentFormat .= "</div>";
...
//            $SectionBrandAssoc = SectionBrand::getBrandSectionMobile();
        ...
        foreach ($divisiAssoc as $index => $DivRow) {
            ...
            $contentFormat .= "<div style=\"text-align:center !important;padding-top: 15px;padding-bottom: 15px;\"><a href=" . url("list/" . $DivRow->id) . "><img width='60%' src='https://www.klikindogrosir.com/public/image/" . $DivRow->images . "'></a></div>";
...
//            $contentFormat .= "</div>";
        ...
        return view('product.product')->with('divdeptkat', $this->getMenuDropdown())->with('elevator', $this->getElevator())->with('Banner', $this->getBanner())->with('content', $contentFormat);
    }
...
//        foreach ($prodDetails as $index => $row) {
//            if ($flagFirst == true) {
//                $htmlFormat .= "<select class='selectpicker' id='PLUSELECT'  data-width='100%'>";
//                $flagFirst = false;
//            }
//            $htmlFormat .= "<div  class='col-md-4' style='margin-top: 20px;text-align: left'>";
//            $hrg = $row['hrg_jual'];
//            $perPcs = "Rp." . number_format($hrg / $row['frac'], 0, ",", ".") . "";
//            if ($row['flagpromomd'] == "1"){
//                $hrgDisc = $row['prmd_hrgjual'];
...
//                $hrgDisc = ($row['hrg_jual'] - $row['prmd_hrgjual']) / $row['frac'] ;
//            }
//            $htmlFormat .= "<option value='" . $row['prdcd'] . "'>" . $row['unit'] . " - ";
//            if ($row['flagpromomd'] == "1" && $hrgDisc > 0) {
//                $htmlFormat .= "<i style='text-decoration: line-through;'>Rp. " . number_format($hrg, 0, ",", ".") . "</i> ( Potongan Harga Rp. " . number_format($hrgDisc, 0, ",", ".") . " Per Pcs) ";
//            }else{
//                $htmlFormat .= "Rp. " . number_format($hrg, 0, ",", ".");
...
//        $htmlFormat .= "</div>";
    ...
    public function getDetailProduct3(Request $Request, $PLU = '%'){
...
//        if($typeuserid == 1) {
//            $htmlFormat .= "<div class='productprice'>
//                       <span style='font-size: small !important'>Harga Termurah : </span><span style='font-size: xx-large !important;'>Rp. " . $row->price != null ? number_format($row->price, 0, ',', '.') : number_format($row->hrg_jual, 0, ',', '.') . "</span>
//                        </div>";
//        }elseif($typeuserid == 3 || $typeuserid == 2){
//                if($row->flagpromomd == 1 && $row->hrg_jual != $row->prmd_hrgjual){
//                $htmlFormat .= "<div class='productprice'>
//                            <i style='text-decoration: line-through;'>Rp. " . number_format($row->hrg_jual, 0, ',', '.') . "</i><br/><span style='font-size: small !important'>Harga Termurah : </span><span style='color: rgb(247, 147, 30); font-weight: 600;font-size: xx-large !important;'>Rp. " . number_format($row->prmd_hrgjual, 0, ',', '.') . "</span>
//                              </div>";
//                }else{
//                $htmlFormat .= "<div class='productprice'>
//                           <span style='font-size: small !important'>Harga Termurah : </span><span style='font-size: xx-large !important; color: rgb(247, 147, 30); font-weight: 600'>Rp. " . number_format($row->hrg_jual, 0, ',', '.') . "</span>
//                            </div>";
//                }
//       }
...
//        if($typeuserid == 1) {
//            $htmlFormat .= "<div class='col-md-12' style='margin-top: 0px; border-width:0px; border-style:solid; border-color:whitesmoke;border-left-width: 0px;border-top-width: 0px;border-bottom-width: 2px;background-color: white;padding-bottom: 0px;margin-bottom: 10px;padding-bottom: 10px;'>
//                        <div style='text-align: left;font-size: small !important;padding-top: 10px;padding-bottom: 10px;'>Dikirim ke : </div>";
//            foreach ($OptAddress as $index => $row) {
//                $htmlFormat .= "
//                             <div class=\"form-group\" style=\"margin-bottom: 0px;float: left;padding-bottom: 5px;\">
//                               <input type='checkbox' name='brand' value=\"\" /><span style='padding-left: 10px;'>Kel." . $row['sub_district_name'] . ", Kec. " . $row['district_name'] . ",  Kota " . $row['city_name'] . ", Prov. " . $row['province_name'] . "</span>
//                            </div>
//                            ";
//            }
//            $htmlFormat .= "</div>";
...
//            $join->on('products.kode_igr', '=', 'ms_picture_productnew.PIC_KODEIGR');
//
//        })->Where('prdcd', $PLU)->whereNotIn('kode_tag', ['A', 'H','O','X','Z','C','N'])->Where('kode_igr', $kodecabang)->first();
//
//
//        $countPic = \DB::table('products')->select('url_pic_prod')->leftJoin('ms_picture_productnew', function ($join) {
//            $join->on('products.prdcd', '=', 'ms_picture_productnew.PIC_PRDCD');
//            $join->on('products.kode_igr', '=', 'ms_picture_productnew.PIC_KODEIGR');
//        })->Where('prdcd', $PLU)->Where('kode_igr', $kodecabang)->whereNotIn('kode_tag', ['A', 'H','O','X','Z','C','N'])->Where('url_pic_prod', '<>', 'null')->Count();
//
//
//        if($plu != null){
//            $htmlFormat .= "<div class='col-md-12' style='font-size: 30px; text-align: left; font-weight: bold; margin-bottom: 10px;'><span>" . $plu->long_description . "</span></div>";
...
//            foreach ($PLU as $index => $plu) {
//                $QTYErr = $this->validateQty($QTY[$index], $plu);
//                if ($QTYErr == 'OK') {
//                    $UNIT = Product::getunit($plu);
//                    Cart::addCartItem($QTY[$index], $plu, $UNIT);
//                } else if ($QTYErr == 'Zero') {
//                    //Skip
//                } else {
//                    \DB::rollBack();
...
//        }
    ...
    public function getCartInfo1(Request $Request)
    {   
        $cFormatRaw = "";

        if(\Auth::guest()){
            $cFormatRaw .= "<div class='warning'>
                                    <a style='vertical-align: middle;'><img  height='100' width='100' src='" . url('../resources/assets/img/bag.png') . "'/></a>
                                </div>";
            $cFormatRaw .= "<div class='warning'>
        ...
        if($kodemember != "" && $typeuserid != 1 && $typeuserid != 3){
...
//            $CartAddress = Address::getAddress();
            ...
            foreach ($CartAddress as $cIdx => $aRow) {
                ...
                if (count($cAssoc) > 0) { // HITUNG CART / ALAMAT, KLO KOSONG SKIP
                    $cFormatRaw .= "<div class='row'><div class='col-md-9' style='box-shadow : 0 1px 4px 0 rgba(0, 0, 0, 0.14);'><table width='100%' style='text-align: start; border-right-color:white;padding-bottom: 0px' class='table table-striped table-condensed table-responsive cart cart" . $aRow['id'] . "' data-id='" . $aRow['id'] . "'>";
                    $cFormatRaw .= "<tr style='background-color: #2980b9'>
                                        ...
                                        <th width='20%' class='hidden-xs' style='text-align: center; color: #FFFFFF; vertical-align: middle;'>Jumlah</th>
...
//                        if($cRow['price']!=0){$diskon = 0;}
                        ...
                        $cFormatRaw .= "</td>
                                            <td class='hidden-xs font-14' style='text-align: right;vertical-align: middle;'><b>Rp. " . number_format($harga - $diskon, 0, ",", ".") . "</b></td>
                                             <td class='hidden-xs font-14' style='text-align: right; vertical-align: middle;'><button class='btn btn-danger flat' onclick='deleteCart(\"" . $cRow['PLU'] . "\")'><i style='color:white' class='fa fa-trash'/></button></td>
                                            </tr>";
                        if($typeuserid != 1 && $typeuserid != 3){
                    ...
                    if ($total < $min_order) {
                        $cFormatRaw .= "<tr class='danger'>
                                            <td colspan='8' class='font-14' style='text-align: center'><b><strong>Pesanan Tidak mencukupi</strong></b></td>
                                            </tr>
                                            <tr class='danger'>
                                             <td colspan='8' class='font-14' style='text-align: center'><b><strong>Minimum Pembelanjaan Anda Rp. " . number_format($min_order, 0, ",", ".") . "</strong></b></td>
                                            </tr>
                                            ";
                        $cFormatRaw .= "<script>
                                    $('.add').click(function () {
...
//                $cFormatRaw .= "<div style='margin-bottom: 10px;'><button style='width: 100%' class='btn btn-danger flat' onclick='deleteAllCart()'><i style='color:white' class='fa fa-trash'/> Hapus Semua Keranjang</button></div>";
                ...
                $cFormatRaw .= "<div style='margin-bottom: 10px'><button style='width: 100%' class='btn btn-warning flat btnupdt' type='submit'><i style='color:white' class='fa fa-refresh'/> Perbarui Keranjang</button>
                                            <script>$(function()
                                            {
...
//                if(count($FlagCabOngkir) > 0 && $totalbelanja < $FlagCabOngkir){   
//                    $cFormatRaw.="<div class='alert alert-warning' role='alert'>
//                                  <h4 class='alert-heading'>Tunggu dulu!</h4>
//                                  <p>Ayo belanja lagi , untuk mendapatkan gratis Ongkir</p>
//                                  <hr style='margin-top: 10px;margin-bottom:10px;'>
//                                  <p class='alert-heading mb-0'>Total belanjaan Anda masih kurang <h3>Rp. " . number_format($FlagCabOngkir - $totalbelanja, 0, ",", ".") . "</h3></p>
//                            </div>";
//                }elseif($countFreeOngkir > 0){
//                    $cFormatRaw.="<div class='alert alert-info' role='alert'>
//                                  <h4 class='alert-heading'>Selamat Kak!</h4>
//                                  <p>Anda mendapatkan Promo Gratis Ongkir</p>
//                                  <hr style='margin-top: 10px;margin-bottom:10px;'>
//                                  <p class='alert-heading mb-0'>Dari Program Promo Gratis Ongkor Member </br></p>
//                            </div>";
//                }else{
//                    $cFormatRaw.="<div class='alert alert-info' role='alert'>
//                                  <h4 class='alert-heading'>Selamat Kak!</h4>
//                                  <p>Anda mendapatkan Promo Gratis Ongkir</p>
//                                  <hr style='margin-top: 10px;margin-bottom:10px;'>
//                                  <p class='alert-heading mb-0'>Total belanjaan Anda sudah memenuhi minimal belanja </br><h3>Rp. " . number_format($FlagCabOngkir, 0, ",", ".") . "</h3></p>
//                            </div>";
//                }
//            }else{
//                $cFormatRaw.="<div class='alert alert-danger' role='alert'>
//                                  <h4 class='alert-heading'>Oops !</h4>
//                                  <p>Pesanan Anda masih <br> < Rp. 1000.000,-</p>
//                                  <p>Silakan ambil pesanan Anda di Toko</p>
//                            </div>";
//            }
...
//                $cFormatRaw .= "<div style='text-align: left'>
//                                <tr class='danger'>
//						            <td colspan='7' class='font-14' >Anda memperoleh : &nbsp; </td>
//					            </tr>
//					            </div>";
//                if($typeuserid != 1) {
//                    foreach ($array as $index => $Row) {
//
//                        //$tipe = $Row['TIPE_PROMOSI'];
//                        // $jenis = $Row['JENIS_PROMOSI'];
//
//                        if ($Row['TIPE_PROMOSI'] == "GIFT" && $Row['JENIS_PROMOSI'] == "PD") {
//                            $cFormatRaw .= "<div><tr class='warning'>
//                               <td colspan='7' class='font-12' style='text-align: left'><b>- " . $Row['QTY'] . " buah &nbsp;" . $Row['KET_HADIAH'] . "</b></td>
//
//                           </tr></div>";
//                        } elseif ($Row['TIPE_PROMOSI'] == "GIFT" && $Row['JENIS_PROMOSI'] == "PR") {
//                            $cFormatRaw .= "<div><tr class='warning'>
//                               <td colspan='7' class='font-12' style='text-align: left'><b>- " . $Row['QTY'] . " POIN dari PROMOSI &nbsp;(" . $Row['NM_PROMOSI'] . ")</b></td>
//
//                           </tr></div>";
//                        }
//                    }
...
//                        if ($unit == 'PCS') {
//                            $cFormatRaw .= "<td class='font-14' style='text-align: center;vertical-align: middle;'><a href='#' id='crt" . $cRow['PLU'] . "'>" . $cRow['qty'] . "</a> " . $unit . "</td>";
//                        } else {
//                            $cFormatRaw .= "<td class='font-14' style='text-align: center;vertical-align: middle;'><a href='#' id='crt" . $cRow['PLU'] . "'>" . $cRow['qty'] . "</a> " . $unit . " (" . ($cRow['qty'] * $frac) . " PCS)</td>";
//                        }
...
//            dd($countFreeOngkir);
            if($total < $min_order){
                $cFormatRaw.="<div class='alert alert-danger' role='alert'>
                                 Total Pembelanjaan Anda Tidak Bisa Kurang dari <br><strong>Rp. " . number_format($min_order, 0, ",", ".") . "</strong>
                            </div>";
            }else
                if($totalbelanja >= 1000000){
...
//                $cartFormatRaw .= "<tr><th colspan='7' width='25%' class='font-15' style='text-align: left; color: black; vertical-align: middle;'>Alamat : " . $aRow['address'] . "</th></tr>";
                foreach ($cAssoc as $cIdx => $cRow) {
                    ...
                    if ($cRow['url_pic_prod'] != null) {
                        ...
                        $cartFormatRaw .= "<td style='vertical-align: middle;'><img  height='100' width='100' src='" . url('../resources/assets/img/noimage.png') . "'/></td>";
                    }
...
//            $cFormatRaw .= "<a href=\"#\" style=\"text-transform:uppercase\" class=\"username\" data-type=\"text\" data-pk=\"\" data-url=\"updtkategori\" data-original-title=\"Enter Category Alias\"></a><script> $('.username').editable();</script>";
    ...
    public function getDetailCheckout1(){
        if (!\Auth::guest()) {
            $typeuserid = \Auth::User()->type_id;
        }
        $userid = \Auth::User()->id;
...
//        }
        ...
        $cFormatRaw .= "<div style='text-align: left; margin-top: 25px;float: right; padding-right: 10px;'><a data-toggle='modal' data-target='.confirm-create' class='btn btn-primary flat'>Lanjutkan Pembayaran</a></div>";

        return view('product.detailcheckout')->with('ListAddress', $CartAddressDefault)->with('detail', $cFormatRaw)->with('cartdetail', $cartFormatRaw)->with('divdeptkat', $this->getMenuDropdown());
    }
...
//
//        if ($typeongkir == 'COD') {
//            $ongkir = 'Diambil Di Toko';
//        } elseif ($typeongkir == 'ANTAR') {
//            //$fee = Auth::User()->shipping_fee;
//            $ongkir = 'Diantar dari Toko';
//        }
...
//                            $flagKenaPromo = array_search((substr($cRow['PLU'], 0, 6) . "0"), array_column($arrayPromosi, 'KD_PLU')); //RETURN-AN AGUS VS PLU CART
                            ...
                            TrDetail::insertDetail($HeaderID, $plu, $qty, $perPcs, $diskon, $stotal);
...
//                            $total = $totalSub - $totalDisc;
    ...
    public function checkOut1($nopo)
    {
            ...
            try {
                ...
                foreach ($CartAddress as $cIdx => $aRow) {
                    ...
                    if (count($cAssoc) > 0) {
                        ...
                        $tdisc = 0;
                        $total = 0;
                        $csv = "Kode Cabang|No Anggota|No Pemesanan|No PO|Tgl Pemesanan|Kode Alamat|Kode PLU|Satuan|Harga (Rp)|Jml Pesanan|Bebas Biaya Pengiriman|Nama Penerima|Email|No Hp|Nama WP|NPWP|Alamat WP\n"; //CSV HEADER
                        foreach ($cAssoc as $cIdx => $cRow) {
                            if($cRow['price'] == null){
                                $harga = $this->cekHargaMBT($cAssoc, $cRow['PLU'], $cRow['qty']);
                                $diskon = $this->cekHargaDiskon($cRow['PLU'], $harga, $cRow['qty']);

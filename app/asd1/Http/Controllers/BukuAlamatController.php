    ...
    if($orderCheck > 0 || $orderCheckCart > 0)
    {
      return redirect('uploadorder')->with('err', 'NO PO Kembar, Silahkan coba mengupload ulang dengan nomor PO yang Berbeda');
        ...
        \DB::beginTransaction();
          ...
          \DB::commit();
            return redirect('uploadorder')->with('opencart', true)->with('divdeptkat', $this->getMenuDropdown())->with('sidebar', $this->getSideBar())->with('divdeptkatmobile', $this->getMenuDropdownMobile());;

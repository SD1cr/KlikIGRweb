...
font-family: 'Lato,sans-serif;';">
    ...
    {{--<span style="font-size:14px">KONFIRMASI PESANAN</span><br/>--}}
    {{--<span style="font-size:14px">NOMOR PESANAN : #{{ str_pad($TRID, 6, '0', STR_PAD_LEFT) }}</span>--}}
    {{--</th>--}}
    {{--</tr>--}}
    <tr class="warning" >
    ...
    <tr class="warning">
        <th class="font-16" style="text-align: left" colspan="8">
            <span style="font-size:16px">Terima Kasih Telah Berbelanja di Klikindogrosir.com</span>
        </th>
    </tr>
    <tr class="warning">
        <td style="text-align: left" colspan="8">
            <span>Dear Bp/Ibu {{$nama}}</span>
        </td>
    </tr>
    ...
    <tr class="warning">
        <td style="text-align: left" colspan="8">
           <span> Pesanan Anda telah kami terima dan siap kami proses.
        Kami akan menghubungi Anda untuk konfirmasi pemesanan. Silakan ditunggu.</span>
        </td>
    </tr>
